...
- `53` modulos activos
- `25` componentes confirmados
- `28` modulos pendientes
...
Cerrar los `28` modulos restantes con evidencia real, no con estimaciones.
...
- reutilizar fixes cortos como paso con `SimpleUtils`
