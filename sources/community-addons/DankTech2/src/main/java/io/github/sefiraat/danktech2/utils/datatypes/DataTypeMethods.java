...
public class DataTypeMethods {
    ...
    public static int getSelectedSlot(ItemStack packStack) {
        return PersistentDataAPI.getInt(packStack.getItemMeta(), Keys.DANK_SELECTED_SLOT, 0);
    }

    public static int incrementSelectedSlot(ItemStack packStack) {
        ...
        if (dankPack != null) {
            ...
            PersistentDataAPI.setInt(itemMeta, Keys.DANK_SELECTED_SLOT, slot);
            packStack.setItemMeta(itemMeta);
            return slot;
        }
        return 0;
    }
